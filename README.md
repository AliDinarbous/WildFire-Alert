...
2. Appel d’une API d’images satellites pour récupérer l’image de la zone
3. Appel d’une API météo pour récupérer les données climatiques
...
- Structurer une architecture complète combinant mobile, back-end et intelligence artificielle
